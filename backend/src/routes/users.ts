...
router.post(
  "/signup",
  uploadMiddleware.single("UserProfilePicture"),
  registerUser,
);
...
router.post(
  "/:userId/items/:itemId/rating-review",
  authMiddleware,
  saveRatingAndReview,
);
router.post(
  "/:userId/top3favorites/movie/:movieId",
  authMiddleware,
  addAMovieToTop3Favorites,
);
router.post(
  "/:userId/top3favorites/tvshow/:tvShowId",
  authMiddleware,
  addATvShowToTop3Favorites,
);
router.delete(
...
router.delete(
  "/:userId/saved-homemade-watchlists/:watchlistId",
  authMiddleware,
  deleteAHomemadeWatchlistFromSavedWatchlists,
);
...
router.post(
  "/:userId/watchlist/movie/:movieId",
  authMiddleware,
  addAMovieToWatchlist,
);
router.post(
  "/:userId/watchlist/tvshow/:tvShowId",
  authMiddleware,
  addATvShowToWatchlist,
);
router.delete(
