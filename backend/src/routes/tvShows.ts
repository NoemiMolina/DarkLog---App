...
router.get("/style/:style", getTVShowsByStyle);
router.get("/:tvShowId/seasons/:seasonNumber", getSeasonByNumber);
router.get(
  "/:tvShowId/seasons/:seasonNumber/episodes/:episodeNumber",
  getEpisodeByNumber,
);
router.post(
  "/:tvShowId/seasons/:seasonNumber/episodes/:episodeNumber/rating",
  addRatingToEpisode,
);
