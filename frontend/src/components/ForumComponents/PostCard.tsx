...
export const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <Card
      id={`post-${post._id}`}
      className={`bg-white/10 backdrop-blur-lg border-white/20 hover:bg-white/15 transition-all duration-500 ${
        isHighlighted
          ? "ring-4 ring-blue-500/50 bg-blue-500/20 scale-[1.02] shadow-2xl shadow-blue-500/30"
          : ""
      }`}
    >
      <CardHeader>
