            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6">
              {movieWatchlist.map((movie) => (
                <div key={movie._id} className="relative group h-56 sm:h-64 md:h-80">
                  <img src={movie.poster} alt={movie.title} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 rounded-lg shadow-lg" />
                  <button
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
              {tvShowWatchlist.map((show) => (
                <div key={show._id} className="relative group h-56 sm:h-64 md:h-80">
                  <img src={show.poster} alt={show.title} className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-300 rounded-lg shadow-lg" />
                  <button
