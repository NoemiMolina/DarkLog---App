              ...
              <div className="block sm:hidden xl:block">
                <Carousel className="w-full">
                  <CarouselContent className="-ml-2">
                    {movies.map((movie) => (
                      <CarouselItem key={movie.id} className="pl-2 basis-2/3 relative group max-h-[400px] xl:max-h-[320px] 2xl:max-h-[380px] overflow-hidden">
                        <img
                          src={movie.poster}
                          alt={movie.title}
            ...
            <>
              ...
              <div className="block sm:hidden xl:block">
                <Carousel className="w-full">
                  <CarouselContent className="-ml-2">
                    {tvShows.map((show) => (
                      <CarouselItem key={show.id} className="pl-2 basis-2/3 relative group max-h-[400px] xl:max-h-[320px] 2xl:max-h-[380px] overflow-hidden">
                        <img
                          src={show.poster}
                          alt={show.title}
                          className="w-full h-full object-contain rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300"
