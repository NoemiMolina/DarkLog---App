              ...
              <div className="block sm:hidden xl:block">
                <Carousel className="w-full">
                  <CarouselContent className="-ml-4 xl:gap-4 2xl:gap-6">
                    {movies.map((movie) => (
                      <CarouselItem key={movie.id} className="basis-2/3 relative group h-[400px] xl:h-[280px] 2xl:h-[330px] overflow-hidden p-0">
                        <img
                          src={movie.poster}
                          alt={movie.title}
                    ...
                    {movies.length < 3 && (
                      <CarouselItem className="basis-2/3 h-[400px] xl:h-[280px] 2xl:h-[330px] p-0">
                        <button
                          onClick={onAddMovie}
            ...
            <>
              ...
              <div className="block sm:hidden xl:block">
                <Carousel className="w-full">
                  <CarouselContent className="-ml-4 xl:gap-4 2xl:gap-6">
                    {tvShows.map((show) => (
                      <CarouselItem key={show.id} className="basis-2/3 relative group h-[400px] xl:h-[280px] 2xl:h-[330px] overflow-hidden p-0">
                        <img
                          src={show.poster}
                          alt={show.title}
                          className="w-full h-full object-contain rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300"
