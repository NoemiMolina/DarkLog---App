        ...
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex gap-2 sm:mt-0 mt-0 -mt-3 mr-2">
            {!isEditing ? (
              <Button
                onClick={onEdit}
                className="bg-gray-800/50 border border-purple-500/20 p-1 sm:p-2"
              >
            ...
            <div className="relative flex-shrink-0">
              {profileData.userProfilePicture ? (
                ...
                <div
                  ...
                  onClick={handleProfilePictureClick}
                >
                  {profileData.userFirstName?.charAt(0).toUpperCase() ||
            ...
            <div className="w-full sm:flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onInputChange("userFirstName", e.target.value)
                  }
                  disabled={!isEditing}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onInputChange("userLastName", e.target.value)
                  }
                  disabled={!isEditing}
                  className="bg-[#1A1A1A] border-white/20 text-white disabled:opacity-60"
                />
