          ...
          complete: async (results) => {
            try {
              const csvData = results.data
                ...
                .filter(
                  (film) => film.name && film.year > 1800 && film.year < 2100,
                );
              ...
              if (!response.ok) {
                ...
                throw new Error(errorData.message || "Error during preview");
              }
              ...
              onError(err instanceof Error ? err.message : "Error unknown");
              setIsLoading(false);
              reject(err);
            }
          },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 flex gap-3">
        ...
        <div className="text-sm text-blue-700 dark:text-blue-300">
          ...
          <p className="text-xs">
            Download your "Diary" list from Letterboxd and ensure the CSV
      ...
      <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
        <p className="text-sm text-amber-800 dark:text-amber-200">
          ...
          <span className="font-semibold">
            Some horror movies have not been imported ?
          </span>{" "}
