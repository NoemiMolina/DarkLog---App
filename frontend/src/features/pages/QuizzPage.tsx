...
const QuizzPage: React.FC<QuizzPageProps> = ({ isTVShowMode }) => {
  ...
  const handleAnswerClick = (answer: string) => {
    ...
    if (
      ...
      questions[currentQuestionIndex].options.indexOf(answer)
    ) {
      setScore(score + 10);
    }
    setTimeout(() => {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Card className="bg-[#2A2A2A] border-red-900/50 border-2">
            <CardContent className="p-8">
              <h2 className="text-2xl mb-8 text-white text-center">
              ...
              <div className="space-y-4">
                {currentQuestion.options.map((option, index) => {
                  let buttonStyle =
                    "bg-[#1A1A1A] hover:bg-[#333333] border-white/20";
                  ...
                  if (selectedAnswer) {
                    if (index === currentQuestion.correctIndex) {
                      ...
                      buttonStyle =
                        "bg-red-600 border-red-400 hover:bg-red-600";
                    }
                  }
  ...
  return (
    <div className="min-h-screen dark:bg-gray-700 text-white flex flex-col items-center justify-center p-4 sm:p-8">
      ...
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4 text-red-600 tracking-wider text-center animate-pulse">
        HORROR QUIZZ
      </h1>
        ...
        >
          <CardContent className="p-4 sm:p-8 text-center">
            ...
            <p className="text-white font-semibold">
              ...
              {mediaType === "movies" ? "horror movies" : "horror TV shows"}.
            </p>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-4 sm:p-8 text-center">
            ...
            <p className="text-white text-sm sm:text-base font-semibold">
              Guess the {mediaType === "movies" ? "movie" : "show"} from the
              worst descriptions.
            </p>
          </CardContent>
        </Card>
