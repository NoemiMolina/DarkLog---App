...
export const ForumPage: React.FC = () => {
  ...
  const { posts, loading, loadPosts, createPost, deletePost, likePost } =
    useForumData();
    ...
    const fetchPostsByTag = async () => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/forum/posts/tags/${encodeURIComponent(selectedTag)}`,
        );
        if (response.ok) {
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="text-center flex-1">
              ...
              <p className="text-white/70">
                Share your opinions about the horror genre and discuss with the
                community
              </p>
            </div>
            <div className="ml-4">
