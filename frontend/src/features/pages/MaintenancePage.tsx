  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-2xl px-4">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-red-500">
          🚨 MAINTENANCE 🚨
        </h1>
        ...
        <div className="bg-gray-800/50 border border-purple-500/30 rounded-lg p-4 sm:p-6 mb-8">
          <p className="text-sm sm:text-base text-gray-300 italic">
            In the meantime, go watch some horror movies and come back to share
            them once FearLog is back from the dead again! 🎬👻
          </p>
        </div>
