        ...
        <main className="min-h-screen relative">
            <section className="py-12">
                ...
                <div className="md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 text-center text-white px-4 mt-8 md:mt-0">
                    <h1 className="font-bold tracking-wide" style={{ fontSize: "var(--type-xxl)", lineHeight: "0.5" }}>Track every movies or tv Shows you've seen.</h1>
                    <h1 className="font-bold tracking-wide mt-4" style={{ fontSize: "var(--type-xxl)", lineHeight: "0.5"  }}>Challenge yourself with themed quizzes.</h1>
                    <h1 className="font-bold tracking-wide mt-4" style={{ fontSize: "var(--type-xxl)", lineHeight: "0.5"  }}>Take part on the horror community.</h1>
                </div>
                <div className="md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 text-center text-white px-4 mt-8 md:mt-0">
                    <span className="text-sm sm:text-base mb-2 font-medium"style={{  lineHeight: "4.5"  }} >
                        Join us on       <FaInstagram className="text-lg sm:text-xl" /* account will be created */ />         and       <FaTiktok className="text-lg sm:text-xl" />
                    </span>
                </div>
                {/* <div className="md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 text-center text-white px-4 mt-8 md:mt-0 grid grid-cols-2 gap-2">
                    <div>Bonjour</div>
                    <div>Bonjour</div>
                    <div>Bonjour</div>
                    <div>Bonjour</div>
